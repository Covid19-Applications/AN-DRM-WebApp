...
.bg-contact{
  background-color: #FFC7C9;
    ...
    <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bg_1 " style="background-image: url(img/hospitals/bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Hospitals In Andaman & Nicobar</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <?php
                                                  $query = "SELECT * FROM hospitals WHERE state = 'andaman & nicobar islands' ";
