...
.btn {
 ...
 <div class="main-content" style="background-color: #069AA8;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Covid19 Dashboard</h2>
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Andaman & Nicobar Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Andaman & Nicobar Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Andaman & Nicobar Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Andaman & Nicobar</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Andaman & Nicobar</h2>
                                <div class="table-responsive table--no-card m-b-40">
                        ...
                        <div class="row">
                                <div class="col-lg-6">
                                     <div class="au-card chart-percent-card" style="height: 700px;">
                                        <div class="au-card-inner">
...
$.ajax({
    ...
    return total
     ...
     var newArrayState = covid_data.filter(function (el) {
      ...
      return el.state === 'Andaman and Nicobar Islands';
    ...
    var conf_rate = (((StateConfirmed)*100)/(126728));
...
$.ajax({
    ...
    var conf_rate = (((IndianConfirmed)*100)/(2834798));
...
$.ajax({
    ...
    // console.log(newArray);
   	...
   	// var StateTests = newArray.sum(parseInt("totaltested"));
    // //document.getElementById("StateTests").innerHTML = StateTests;
...
$.ajax({
   ...
   //console.log(covid_data_zone.zones);
    ...
    //console.log(Green.length); 
    var Greenlength = Math.round((Green.length/3)*100);
    document.getElementById("Greenzone-per").innerHTML = Greenlength;
     ...
     var Redlength = Math.round((Red.length/3)*100);
    document.getElementById("Redzone-per").innerHTML = Redlength;
    ...
    var Orangelength =  Math.round((Orange.length/3)*100);
    document.getElementById("Orangezone-per").innerHTML = Orangelength;
