...
.INDIVIDUALS{
  background-color: lightblue; /* For browsers that do not support gradients */
    background: linear-gradient(to left,  #F7E967 0%, #62997A  100%);
}


.ORGANISATIONS{
   background-color:lightblue; /* For browsers that do not support gradients */
    background: linear-gradient(to left, #62997A 0% ,#A8D0E6 100%);
}
...
<div class="card-deck">
  ...
  <div class="card text-center ORGANISATIONS ">
    <div class="card-body">
      ...
      <a href="https://self4society.mygov.in/cv_type/organisation/"><button><p class="card-text" style="color: white"> VOLUNTEER NOW</p></button></a>
    </div>
  </div>
